# Investor Profile — Reference Material

This file contains the question bank, validation rules, risk profiling guidance, and output template for the investor profile skill. Read this when you need specifics on what to ask, how to validate answers, or how to format the final `investor-profile.md`.
