...
The report template, section specifications, formatting standards, and example sections are in the reference sections below.
...
Write `report.md` following the template structure in the reference sections below. The report has 8 sections, each serving a specific purpose:
...
See the reference sections below for detailed guidance on each section's content and tone.
...
- **Read the reference sections below before writing.** They contain the template, section specs, and formatting standards. Following them produces consistent, high-quality reports.
