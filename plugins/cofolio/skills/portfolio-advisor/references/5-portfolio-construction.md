...
- **Don't re-screen instruments.** This stage assigns weights and runs analysis on existing instruments. If the user wants to swap an instrument, that's Stage 4. You can suggest it, but don't invoke the security screening prompt yourself.
